...
public class Salary {
    ...
    @Getter @Setter private String monthNum;
    ...
    @Getter @Setter private String agreeNum;
    @Getter @Setter private String oppNum;
    @Getter @Setter private String graNum;
    @Getter @Setter private String shareNum;
    @Getter @Setter private String reserveNum;
